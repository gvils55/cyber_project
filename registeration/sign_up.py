...
class Sign_up:
    ...
    def main(self):
        ...
        #    username text, phone text, gmail text, password text
        #    )""")
        ...
        def submit():
            ...
            if can_register is True:
                ...
                c.execute("INSERT INTO clients VALUES(:username, :phone, :gmail, :password)",
                          {
        ...
        #c.execute("DELETE from addresses WHERE oid = 3")
